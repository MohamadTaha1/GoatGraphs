    ...
    <div className="container py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
        <div className="relative h-[400px]">
          <Image src="/placeholder.svg?height=400&width=500" alt="Our Story" fill className="object-cover rounded-lg" />
        </div>
        <div>
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { name: "John Smith", title: "Founder & CEO", image: "/placeholder.svg?height=200&width=200" },
            { name: "Sarah Johnson", title: "Authentication Expert", image: "/placeholder.svg?height=200&width=200" },
            { name: "Michael Brown", title: "Head of Acquisitions", image: "/placeholder.svg?height=200&width=200" },
            {
              name: "Emma Wilson",
