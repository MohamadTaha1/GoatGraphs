...
import { addCategory } from "@/hooks/use-categories"
...
export default function AddCategoryPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const categoryId = await addCategory(categoryData, imageFile || undefined)
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-offwhite/70 font-body">Create a new product category</p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-sm text-offwhite/70">{imageFile ? imageFile.name : "No image selected"}</span>
                </div>
                {imagePreview && (
                  <div className="mt-4">
