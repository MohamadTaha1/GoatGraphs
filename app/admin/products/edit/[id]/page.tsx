  ...
  useEffect(() => {
    async function loadProduct() {
      try {
        ...
        toast({
          title: "Error",
          description: "Failed to load the product. Please try again.",
          variant: "destructive",
        })
      } finally {
        setIsLoading(false)
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-offwhite/70 font-body">Update product information</p>
        </div>
      </div>
                        ...
                        <Button
                          ...
                          onClick={() => {
                            if (imageFile) {
                              ...
                              // If it's the original image, show upload UI
                              setImagePreview(null)
                            }
                          }}
                        >
                          {imageFile ? "Cancel" : "Change"}
                        </Button>
                      </div>
                    ) : (
                      <>
