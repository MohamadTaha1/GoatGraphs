...
import { ShoppingCart, Filter, Search, Loader2, ShoppingBag, Pencil } from "lucide-react"
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <Tabs defaultValue={activeTab} value={activeTab} className="w-full mb-8" onValueChange={setActiveTab}>
        ...
        <TabsContent value="pre-order">
          {/* Search and Filter Bar for Pre-Orders */}
          <div className="flex flex-col md:flex-row gap-4 mb-8">
            <div className="relative flex-1">
              <Search className="absolute left-2.5 top-2.5 h-4 w-4 text-offwhite/50" />
              <Input
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <Checkbox
                        id="type-shirt-preorder"
                        checked={selectedTypes.shirt}
                        onCheckedChange={() => handleTypeChange("shirt")}
                        className="border-gold/50 data-[state=checked]:bg-gold data-[state=checked]:text-jetblack"
                      />
                      <Label htmlFor="type-shirt-preorder" className="ml-2 text-offwhite">
                        Shirts
                      </Label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox
                        id="type-ball-preorder"
                        checked={selectedTypes.ball}
                        onCheckedChange={() => handleTypeChange("ball")}
                        className="border-gold/50 data-[state=checked]:bg-gold data-[state=checked]:text-jetblack"
                      />
                      <Label htmlFor="type-ball-preorder" className="ml-2 text-offwhite">
                        Balls
                      </Label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox
                        id="type-photo-preorder"
                        checked={selectedTypes.photo}
                        onCheckedChange={() => handleTypeChange("photo")}
                        className="border-gold/50 data-[state=checked]:bg-gold data-[state=checked]:text-jetblack"
                      />
                      <Label htmlFor="type-photo-preorder" className="ml-2 text-offwhite">
                        Photos
                      </Label>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <RadioGroup value={priceRange} onValueChange={handlePriceRangeChange} className="space-y-2">
                    <div className="flex items-center">
                      <RadioGroupItem value="all" id="price-all-preorder" className="border-gold/50 text-gold" />
                      <Label htmlFor="price-all-preorder" className="ml-2 text-offwhite">
                        All Prices
                      </Label>
                    </div>
                    <div className="flex items-center">
                      <RadioGroupItem
                        value="under100"
                        id="price-under100-preorder"
                        className="border-gold/50 text-gold"
                      />
                      <Label htmlFor="price-under100-preorder" className="ml-2 text-offwhite">
                        Under $100
                      </Label>
                    </div>
                    <div className="flex items-center">
                      <RadioGroupItem
                        value="100to500"
                        id="price-100to500-preorder"
                        className="border-gold/50 text-gold"
                      />
                      <Label htmlFor="price-100to500-preorder" className="ml-2 text-offwhite">
                        $100 - $500
                      </Label>
                    </div>
                    <div className="flex items-center">
                      <RadioGroupItem
                        value="500to1000"
                        id="price-500to1000-preorder"
                        className="border-gold/50 text-gold"
                      />
                      <Label htmlFor="price-500to1000-preorder" className="ml-2 text-offwhite">
                        $500 - $1000
                      </Label>
                    </div>
                    <div className="flex items-center">
                      <RadioGroupItem
                        value="over1000"
                        id="price-over1000-preorder"
                        className="border-gold/50 text-gold"
                      />
                      <Label htmlFor="price-over1000-preorder" className="ml-2 text-offwhite">
                        Over $1000
                      </Label>
                    </div>
                  </RadioGroup>
