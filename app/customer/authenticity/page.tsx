    ...
    <div className="container py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
        ...
        <div className="relative h-[400px]">
          <Image
            src="/images/authentication-expert.png"
      ...
      <div className="bg-black text-white rounded-lg p-8 mb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative h-[300px]">
            <Image
              src="/images/certificate-detail.png"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="border-2 border-gold-500">
            <CardContent className="pt-6">
              ...
              <div className="mt-4 h-32 relative">
                <Image src="/images/acquisition.png" alt="Acquisition" fill className="object-cover rounded-lg" />
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-gold-500">
            <CardContent className="pt-6">
              ...
              <div className="mt-4 h-32 relative">
                <Image src="/images/verification.png" alt="Verification" fill className="object-cover rounded-lg" />
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-gold-500">
            <CardContent className="pt-6">
              ...
              <div className="mt-4 h-32 relative">
                <Image src="/images/documentation.png" alt="Documentation" fill className="object-cover rounded-lg" />
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-gold-500">
            <CardContent className="pt-6">
              ...
              <div className="mt-4 h-32 relative">
                <Image src="/images/certification.png" alt="Certification" fill className="object-cover rounded-lg" />
              </div>
            </CardContent>
          </Card>
        </div>
      ...
      <div className="text-center mb-16">
        ...
        <div className="mt-8 relative h-[200px] max-w-md mx-auto">
          <Image
            src="/images/verify-certificate.png"
      ...
      <div className="bg-gray-100 rounded-lg p-8 text-center">
        ...
        <div className="mt-8 relative h-[200px] max-w-md mx-auto">
          <Image src="/images/expert-team.png" alt="Our Expert Team" fill className="object-cover rounded-lg" />
        </div>
      </div>
    </div>
  )
