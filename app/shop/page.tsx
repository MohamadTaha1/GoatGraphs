...
const mockProducts = [
  ...
  },
  {
    ...
    description: "Match jersey signed by Cristiano Ronaldo after his record-breaking goal.",
    createdAt: new Date().toISOString(),
  },
  {
    id: "3",
    title: "Mbappé Signed Jersey",
    type: "shirt",
    signedBy: "Kylian Mbappé",
    price: 999.99,
    available: true,
    imageUrl: "/images/mbappe-signed-jersey.png",
    description: "Limited edition signed jersey of Kylian Mbappé from PSG.",
    createdAt: new Date().toISOString(),
  },
  {
    id: "4",
    title: "Neymar Signed Jersey",
    type: "shirt",
    signedBy: "Neymar Jr.",
    price: 899.99,
    available: true,
    imageUrl: "/images/neymar-signed-jersey.png",
    description: "Authentic signed jersey from Neymar Jr. with PSG.",
    createdAt: new Date().toISOString(),
  },
  {
    id: "5",
    title: "Haaland Signed Jersey",
    type: "shirt",
    signedBy: "Erling Haaland",
    price: 799.99,
    available: false,
    imageUrl: "/images/haaland-signed-jersey.png",
    description: "Limited edition signed Manchester City jersey from Erling Haaland.",
    createdAt: new Date().toISOString(),
  },
]
